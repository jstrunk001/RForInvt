...
#'@examples
#'
#' #build a prototype keyword file (a character vector with @@token@@ placeholders)
#' key_proto = fvs_prototype_keyfile(invyr = "InvYear       2001", notriple = NULL)
#' head(key_proto)
#'
#'\dontrun{
#' #use it in the full pipeline
...
#'@export
#
#'@seealso \code{\link{fvs_run}}\cr \code{\link{fvs_load}}\cr
