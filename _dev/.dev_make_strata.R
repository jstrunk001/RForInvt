...
str_htba = make_strata(carbon_lrm_ol , x1="HEIGHT" , x2="BA_ALL", wt = "Net_Ac" ,  n1 = 4, n2 = 3 );str_htba
carbon_str = merge(str_htba[,c("stratum","stratum1")],assign_strata(str_htba, carbon_lrm_ol),by="stratum")
