#' @title Predict Log-Level Volume and Dimensions using NVEL (Parallel)
#'
#' @description
...
#'
#' @return A \code{data.table} in long format (one row per log).
#'
#' @author Jacob Strunk <jstrunk@@fs.fed.us> (Original Logic), Refactored for data.table/Parallel by [Your Name]
#'
#' @examples
#' \dontrun{
#' library(data.table)
